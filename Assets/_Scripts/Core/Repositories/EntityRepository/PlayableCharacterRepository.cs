...
class PlayableCharacterData
{
    ...
    public static PlayableCharacterData Populate(PlayableCharacter playableCharacter)
    {
        ...
        playableCharacterData.Personality   = playableCharacterData.Personality;
        playableCharacterData.Species       = playableCharacterData.Species.ToString();
